    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          <Systemes
			...
			@nouvellesCoordonnees="envoiCoordonnees"
			/>
        </div>
    </div>
  </div>
...
const emit = defineEmits(["updateCoordonnees"]);

function envoiCoordonnees(x, y) {
  emit("updateCoordonnees", x, y);
}
